...
class SoloClassicConfigScreen extends StatefulWidget {
  ...
  @override
  State<SoloClassicConfigScreen> createState() =>
      _SoloClassicConfigScreenState();
}
  ...
  void _startGame() async {
    ...
    if (sessionId != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Erreur lors de la création de la session')),
      );
    }
  }
        ...
        child: Column(
          children: [
            ...
            const Align(
              ...
              child: Text('Nombre de questions',
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child:
                  Text('Difficulté', style: TextStyle(color: AppColors.text)),
            ),
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child:
                  Text('Catégories', style: TextStyle(color: AppColors.text)),
            ),
            Expanded(
              child: ListView(
